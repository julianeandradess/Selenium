...
class Selenium {
	...
	@BeforeEach //gancho para iniciar todo o processo
	void start(){
		driver = new ChromeDriver();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5)); 
	}

	@AfterEach //gancho para fechar a pagina, mesmo que dê erro por qualquer que seja o motivo
	void finish(){
		driver.close();
	}
	...
	void createPoint() {
		...
		WebElement complement = driver.findElement(By.cssSelector("input[name=addressDetails]"));
		complement.sendKeys("Ao lado da padaria");
